...
export class LLMService {
  static async getCurrentLLM(): Promise<string> {
    return llmService.getCurrentLlmType()
  }

  static async setLLMType(llmType: 'XModel' | 'BigModel'): Promise<void> {
    return llmService.setLlmType(llmType)
  }

  static async getSuggestion(param: string): Promise<string> {
    return llmService.getSuggestion(param)
  }

  static streamChat(param: string, callbacks: StreamChatCallbacks): EventSource | null {
    return llmService.streamChat(param, callbacks)
  }
}
